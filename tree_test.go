...
func Test_TreeWalkPost(t *testing.T) {
	testutil.PrepareWorkspace("test_resources/testrepo")
	defer testutil.CleanupWorkspace()
	repo, _ := OpenRepository("test_resources/testrepo")
	if repo == nil {
	...
	count := 0
	err = tree.WalkPost(func(root string, entry *TreeEntry) int {
		count++
		return 0
	})
	if count != 3 {
...
func Test_TreeWalkPostStop(t *testing.T) {
	testutil.PrepareWorkspace("test_resources/testrepo")
	defer testutil.CleanupWorkspace()
	repo, _ := OpenRepository("test_resources/testrepo")
	if repo == nil {
...
func Test_TreeWalkPostSkip(t *testing.T) {
	testutil.PrepareWorkspace("test_resources/testrepo")
	defer testutil.CleanupWorkspace()
	repo, _ := OpenRepository("test_resources/testrepo")
	if repo == nil {
